...
func TestButlerConfig(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ButlerConfig Controller Suite")
}
...
// Helper to create a ButlerConfig for testing
func newButlerConfig(name string, mode butlerv1alpha1.MultiTenancyMode, defaultNS string) *butlerv1alpha1.ButlerConfig {
...
// Helper to create a TenantCluster for testing
func newTenantCluster(name, namespace string) *butlerv1alpha1.TenantCluster {
