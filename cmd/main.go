...
func init() {
	...
	// TODO: Add CAPI and Kamaji schemes when implementing full reconciliation
...
func main() {
	...
	if secureMetrics {
		...
		// More info: https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.19.1/pkg/metrics/filters#WithAuthenticationAndAuthorization
	...
	// ButlerConfig controller (singleton, platform configuration)
	...
	// Team controller (creates namespaces and RBAC)
	...
	// TenantCluster controller (creates CAPI/Kamaji resources and addons)
	...
	// TenantAddon controller (manages post-creation addons)
	...
	// KamajiSecret controller (translates kubeconfig format for CAPI)
	...
	// KamajiStatus controller (patches KamajiControlPlane status for Harvester)
